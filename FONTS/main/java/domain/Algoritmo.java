 ...
 * Interfaz Algoritmo
 * 
 * Esta interfaz define el contrato que deben seguir todos los algoritmos de
 * generación de distribuciones.
 * Los algoritmos implementarán el método generarDistribucion para crear una
 * matriz de caracteres basada en
...
public interface Algoritmo {
     ...
     * 
     * @param alfabeto              El alfabeto sobre el cual se generará la
     *                              distribución.
